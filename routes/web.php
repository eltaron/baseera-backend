...
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'can:access-student-panel'])->prefix('student')->group(function () {
    ...
    Route::post('/quiz/submit', [StudentController::class, 'submitQuiz'])->name('student.quiz.submit');
